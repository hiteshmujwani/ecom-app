...
const [product,setProduct] = useState({})
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={`${process.env.REACT_APP_API}/api/v1/product/product-photo/${product._id}`} />
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex">
          <button type="button" className="button align-self-end" onClick={()=>{setCart([...cart,product]); toast.success("ITEM ADDED TO CART"); localStorage.setItem('cart',JSON.stringify([...cart,product]))}}>

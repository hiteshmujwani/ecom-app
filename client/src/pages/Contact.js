          ...
          <form action="#!">
            <div className="row gy-4 gy-xl-5 p-4 p-xl-5">
              <div className="col-12">
                ...
                <input type="text" className="form-control" id="fullname" value="" required/>
              </div>
              <div className="col-12 col-md-6">
                ...
                <div className="input-group">
                  ...
                  <input type="email" className="form-control" id="email" value="" required/>
                </div>
              </div>
              <div className="col-12 col-md-6">
                ...
                <div className="input-group">
                  ...
                  <input type="tel" className="form-control" id="phone" value=""/>
                </div>
              </div>
              <div className="col-12">
